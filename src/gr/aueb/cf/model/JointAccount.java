...
public class JointAccount extends Account {
    ...
    public String toString() {
        return "JointAccount{" + "First Holder= " + getHolder() +
                ", secondHolder=" + secondHolder + ", iban: " + getIban() + ", balance: " + getBalance() +
                '}';
    }

    @Override
    protected boolean isSsnValid(String ssn) {
        return super.isSsnValid(ssn) || secondHolder.getSsn().equals(ssn); // We could check for nulls for secondHolder
    }
}
